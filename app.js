...
app.get('/ext/github-acld', function (req, res) { // Redirects to the Figma prototype for Linker, a new type of messaging app.
    res.redirect('https://github.com/ActuallyCloud/ACLD');
});
